...
· Workers want assurance they can redeem tokens for Bitcoin
· Employers want assurance tokens have value for paying workers
· Market makers need incentives to provide initial liquidity
· Community needs sustainable liquidity without external dependency

Specific Constraints

· No premine/founders: Avoid centralization and rent-seeking
· Progressive decentralization: Start simple, become trust-minimized
· Capital efficiency: Maximize Bitcoin utility
· Attack resistance: Prevent manipulation during bootstrap
...
1. Early Liquidity Provider (LP) Rewards:
